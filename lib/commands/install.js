...
var repos = {
  dotfiles: 'https://github.com/adamcolejenkins/stackbox-dotfiles.git'
};
...
module.exports = function(args, options, callback, ee) {
  ...
  var tasks = [
    preflight, prompt, cloneDotfiles, folderSetup
  ];
  ...
  function cloneDotfiles(cb) {
    var repo = options.dotfiles || repos.dotfiles;

    process.chdir( home );

    // Clone the dotfiles repository
    git.Clone(repo, '.stackbox').catch(function (err) {
